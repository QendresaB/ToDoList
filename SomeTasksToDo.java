...
/**
 * SomeTasksToDo models daily tasks
 */
public class SomeTasksToDo {
    ...
    public SomeTasksToDo() {
        tasks = new Tasks[DAYS][HOUR_OF_DAY]; //has rows equal to the number of days of 24(hours in a day) elements
     ...
     *@param task - String as a task
     *@param day the day of a task
     *@param hour the hour of a task */
    ...
    public void appendToTasks(String task, int day, int hour) {
     ...
     /**generalTasks asks the user to put some Tasks as general in a row of days
       *in a specific hour
       *@param frame the output frame */
  ...
  { 
    ...
    /** contents  returns the current state of the Tasks objects
      * @param hour -hour of a task
      * @param day - day of a task
    ...
    /** contentsOfTasks  returns the current state of the tasks as a String object
     * @param day a task's day
     * @param hour a task's hour
     * @return String an element of a 2D String array */
