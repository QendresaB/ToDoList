...
public class ToDoListController extends JPanel {
    ...
    private final boolean[][] done_tasks; // boolean two-dimensional array which holds the current state of a task
   ...
   /**taskDone based in the users input assigns boolean value to the boolean two dimensional array
     *with the same row and column indexes*/
    public void taskDone() {
        ...
        if (values.length == 2) {
            ...
            if (day < 1 || day > DAYS+1 || hour < 0 || hour > HOUR_OF_DAY-1 ) 
            {
    ...
    /**printTasks prints tasks based on the current state of the two-dimensional array containers*/
